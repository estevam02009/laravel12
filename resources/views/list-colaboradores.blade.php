                    ...
                    <tbody>
                        @foreach ($colaboradores as $colaborador)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('colaborador.detalhes', $colaborador->id) }}" class="btn btn-warning">Detalhes</a>
                                </td>
                                <td class="text-end">
                                    <a href="{{ route('colaborador.edit', '$colaborador->id') }}" class="btn btn-success">Editar</a>
                                </td>
                                <td class="text-end">
                                    <button
                                        type="button"
                                        ...
                                        data-bs-taget="#confirmDeleteModal"
